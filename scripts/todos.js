...
async function loadTodos() {
  ...
  try {
    ...
    // This is running on a totally different server than the server this
    // front end is on. So this will fetch data from the api we created on the
    // 0044 project, which runs on localhost:3000 port
    // This decoupled front end runs on localhost:5500 port
  } catch (error) {
...
function createTodoListItem(todoText, todoId) {
  ...
  // this will create a data-todoid data attribute
